...
A zero-dependency, CSP-safe top-of-page progress bar built as a native Web Component. A lightweight Next.js toploader for App Router, and it also works in any framework — or no framework at all.
